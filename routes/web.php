...
use App\Http\Controllers\{ChangePasswordController, HomeController, InfoUserController, RegisterController, ResetController, SessionsController, MoodController, TespsikologiController, ArtikelController, KonsultasiController, DashboardadminController, DashboardpsikologController, DaftarPsikologController, HasilKonsultasiController};
...
Route::get('/', function () {
    if (auth()->check()) {
        ...
        switch ($role) {
            ...
            case 2:
                return redirect()->route('psikolog.dashboardpsikolog');
        }
    }
    return view('landing'); // jika belum login, tampilkan halaman landing
})->name('landing');
...
Route::middleware(['auth', 'role:0'])->group(function () {
    ...
    Route::view('/artikel','artikel.index')->name('artikel.index');
    ...
    Route::view('/Daftar-psikolog', 'Daftar-Psikolog')->name('Daftar-psikolog');
...
Route::middleware(['auth', 'role:1'])->group(function () {
    ...
    Route::get('psikolog/tabelpsikolog', [DaftarPsikologController::class, 'index'])->name('psikolog.tabelpsikolog');
