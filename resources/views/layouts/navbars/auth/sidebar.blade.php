...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
        <img src="../assets/img/logoapp.png" class="navbar-brand-img h-100" alt="logo">
        <span class="ms-1 font-weight-bold">MindTrack</span>
    </a>
  </div>
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('mood') ? 'active' : '') }}" href="{{ url('mood') }}">
          ...
          <span class="nav-link-text ms-1">Mood Tracking</span>
        </a>
      </li>
      ...
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('artikel') ? 'active' : '') }}" href="{{ url('artikel') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ (Request::is('artikel') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
            </div>
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('tables') ? 'active' : '') }}" href="{{ url('tables') }}">
          ...
          <span class="nav-link-text ms-1">Daftar Psikolog</span>
        </a>
      </li>
      {{-- <li class="nav-item mt-2">
        <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">User Managemen</h6>
      </li>
      <li class="nav-item">
  ...
  <div class="sidenav-footer mx-3 mb-4"> <!-- Tambahkan margin-bottom di sini -->
    <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
      <div class="full-background" style="background-image: url('../assets/img/pikir.jpeg')"></div>
      <div class="card-body text-start p-3 w-100">
        <div class="docs-info">
          <h6 class="text-white up mb-0">Perbaiki mentalmu bersama Kami &#128516;</h6>
        </div>
      </div>
    </div>
  </div>

  <div class="sidenav-footer mx-3 mb-4"> <!-- Juga di card kedua -->
    <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
      <div class="full-background" style="background-image: url('../assets/img/pikir.jpeg')"></div>
      <div class="card-body text-start p-3 w-100">
        <div class="docs-info">
          <h6 class="text-white up mb-0">Buat harimu menjadi lebih baik &#128513;</h6>
        </div>
      </div>
    </div>
  </div>
