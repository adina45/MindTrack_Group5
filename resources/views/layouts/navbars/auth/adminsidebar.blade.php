...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('admin.dashboardadmin') }}">
        ...
        <ul class="navbar-nav">
            <li class="nav-item">
            <a class="nav-link {{ (Request::is('admin.dashboardadmin') ? 'active' : '') }}" href="{{ url('admin.dashboardadmin') }}">
            ...
            <li class="nav-item">
                <a class="nav-link {{ (Request::is('psikolog.tabelpsikolog') ? 'active' : '') }} " href="{{ url('psikolog.tabelpsikolog') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
