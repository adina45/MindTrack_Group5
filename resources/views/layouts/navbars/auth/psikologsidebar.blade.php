...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('psikolog.dashboardpsikolog') }}">
        ...
        <ul class="navbar-nav">
            <li class="nav-item">
            <a class="nav-link {{ (Request::is('psikolog.dashboardpsikolog') ? 'active' : '') }}" href="{{ url('psikolog.dashboardpsikolog') }}">
            ...
            <li class="nav-item">
                <a class="nav-link {{ (Request::is('psikolog-profile') ? 'active' : '') }} " href="{{ url('psikolog-profile') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
