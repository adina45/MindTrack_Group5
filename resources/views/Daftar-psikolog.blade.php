                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="align-middle text-center">
                      ...
                      <a href="{{ route('konsultasi', ['nama' => 'Dr. Sarah Wijaya']) }}" class="btn btn-sm btn-success">Konsultasi</a>
                  ...
                  <tr>
                    ...
                    <td class="align-middle text-center">
                      ...
                      <a href="{{ route('konsultasi', ['nama' => 'Dr. Budi Santoso']) }}" class="btn btn-sm btn-success">Konsultasi</a>
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td class="align-middle text-center">
                      ...
                      <a href="{{ route('konsultasi', ['nama' => 'Dr. Angga Saputra']) }}" class="btn btn-sm btn-success">Konsultasi</a>
                    </td>
                  </tr>
