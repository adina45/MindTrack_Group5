                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-header">
                                <h5 class="modal-title" id="chooseAvatarModalLabel">Pilih Avatar</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                            </div>
                            <div class="modal-body d-flex flex-wrap gap-3">
                                @foreach(['avataricon(1).jpeg', 'avataricon(2).jpeg', 'avataricon(3).jpeg', 'avataricon(4).jpeg'] as $avatar)
                                <label>
                                    <input type="radio" name="avatar" value="{{ $avatar }}" class="d-none">
                                    <img src="{{ asset('../assets/img/avatars/' . Auth::user()->avatar) }}" alt="..." class="w-100 border-radius-lg shadow-sm">
            ...
            <div class="card-body pt-4 p-3">
                <form action="/user-profile" method="POST" role="form text-left">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="user.phone" class="form-control-label">{{ __('Nmor Telepon') }}</label>
